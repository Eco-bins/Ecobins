"""
Django settings for ecobins project.
...
SECRET_KEY = 'django-insecure-tqnlb50^uky*u=*q3^04qhxx+fxko)u=)k(#&q=%sw@u-r+8+7'
...
WSGI_APPLICATION = 'ecobins.wsgi.application'
